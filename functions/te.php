...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  <li class="nav-item">
    <a class="nav-link active" id="home-tab" data-toggle="tab" href="cliente_c_1.html" role="tab" aria-controls="home" aria-selected="true">Nível 1</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="profile-tab" data-toggle="tab" href="cliente_c_2.html" role="tab" aria-controls="profile" aria-selected="false">Nível 2</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="contact-tab" data-toggle="tab" href="cliente_c_3.html" role="tab" aria-controls="contact" aria-selected="false">Nível 3</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="3-tab" data-toggle="tab" href="cliente_c_4.htmls" role="tab" aria-controls="contact" aria-selected="false">Nível 4</a>
  </li>
</ul>
...
<br><br>
           <form method="POST" action="cliente_c_1.php">
            <div class="form-row">
